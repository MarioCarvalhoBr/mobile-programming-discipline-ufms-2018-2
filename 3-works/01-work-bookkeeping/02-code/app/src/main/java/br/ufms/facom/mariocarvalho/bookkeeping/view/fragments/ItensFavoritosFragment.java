...
public class ItensFavoritosFragment extends Fragment {
    ...
    public ItensFavoritosFragment() {
        // Required empty public constructor
    }

    public static ItensFavoritosFragment newInstance(String param1, String param2) {
        ItensFavoritosFragment fragment = new ItensFavoritosFragment();
